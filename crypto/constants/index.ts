...
export const ENTRIES_OPEN_COUNTDOWN_DURATION = 15_000
export const PRE_SPIN_DURATION = 3_000
export const WHEEL_SPINNING_DURATION = 3_000
export const RESULT_SCREEN_DURATION = 3_000
export const SEC_MS = 1000
export const SEED_USER_SUBMIT_FEQUENCY = 2_000 // Amount of secs between seed user batchEntry submits
