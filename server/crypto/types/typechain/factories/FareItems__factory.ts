...
import type { FareItems, FareItemsInterface } from '../FareItems'
...
export class FareItems__factory {
	static readonly abi = _abi
	static createInterface(): FareItemsInterface {
		return new utils.Interface(_abi) as FareItemsInterface
	}
	static connect(address: string, signerOrProvider: Signer | Provider): FareItems {
