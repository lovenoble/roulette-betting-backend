...
const { UserClient } = require("../lib/rpc/protos/generated/user_grpc_pb");
...
const e2eSequence00 = () => {
  ...
  beforeAll(async () => {
    ...
    await driver.wait(
      ...
      5000,
      "5 second timeout --> wait for page to load",
      1000
    );
  });
  ...
  //       until.elementLocated(By.name(ABOUT_BTN)),
  //       5000,
  //       "5 second timeout --> check target strategy: ABOUT_BTN",
  //       1000
  //     );
  ...
  //       until.elementLocated(By.name(ABOUT_BTN_MDL)),
  //       5000,
  //       "5 second timeout --> check target strategy: ABOUT_BTN_MDL",
  //       1000
  //     );
  ...
  //       until.elementLocated(By.name(ABOUT_MDL_CLOSE_BTN)),
  //       5000,
  //       "5 second timeout --> check target strategy: ABOUT_MDL_CLOSE_BTN",
  //       1000
  //     );
  ...
  //     const connect = await driver.wait(
  //       until.elementsLocated(By.name(GAME_MENU_MDL_BTNS)),
  //       5000,
  ...
  //       until.elementLocated(By.name(CONNECT_WALLET_WARN)),
  //       5000,
  //       "5 second timeout",
  //       1000
  //     );
  ...
  //     const rocket = await driver.wait(
  //       until.elementsLocated(By.name(GAME_BTNS)),
  //       5000,
  //       "5 second timeout --> check target strategy: GAME_BTNS[1]",
  //       1000
  //     );
  ...
  //     const dice = await driver.wait(
  //       until.elementsLocated(By.name(GAME_BTNS)),
  //       5000,
  //       "5 second timeout --> check target strategy: GAME_BTNS[2]",
  //       1000
  //     );
  ...
  //     const guest = await driver.wait(
  //       until.elementsLocated(By.name(GAME_MENU_MDL_BTNS)),
  //       5000,
  //       "5 second timeout --> check target strategy: GAME_MENU_MDL_BTNS[0]",
  //       1000
  //     );
  ...
  //     const play2X = await driver.wait(
  //       until.elementsLocated(By.name(GAME_MODE_BTNS)),
  //       5000,
  //       "5 second timeout --> check target strategy: GAME_MODE_BTNS[0]",
  //       1000
  //     );
  //     if (play2X.length === 3) {
  //       return true;
  ...
  //     const colors = await driver.wait(
  //       until.elementsLocated(By.name(COLOR_SELECTION)),
  //       5000,
  //       "5 second timeout --> check target strategy: COLOR_SELECTION",
  //       1000
  //     );
  //     if (colors.length > 0) {
  ...
  //     }
  //     const warning = await driver.wait(
  //       until.elementLocated(By.name(WAGER_WARNING)),
  //       5000,
  //       "5 second timeout",
  //       1000
  //     );
  ...
  //     const metaverse = await driver.wait(
  //       until.elementsLocated(By.name(META_DEMO_BTN)),
  //       5000,
  //       "5 second timeout --> check target strategy: META_DEMO_BTN",
  //       1000
  //     );
  ...
  //     const modal = await driver.wait(
  //       until.elementsLocated(By.name(META_DEMO_MODAL)),
  //       20000,
  //       "20 second timeout --> check target strategy: META_DEMO_MODAL",
  //       1000
  //     );
  //     return checkExistence(modal);
  //   });
  ...
  describe("redis store test", () => {
    it("test generate nonce", async () => {
      const userClient = new UserClient("http://localhost:8080", null, null);
      const request = new UserClient.GenerateNonceRequest();
      request.setPublicaddress("0x0bEB3097F8e61FB90432d151590D701C5D90f614");
      const nonce = await userClient.generateNonce(request, null);
  ...
  describe("check F logo link", () => {
    test("check target strategy: F_LOGO_BTN", async () => {
      const logo = await driver.wait(
        until.elementsLocated(By.name(F_LOGO_BTN)),
        5000,
        "5 second timeout --> check target strategy: F_LOGO_BTN",
        1000
      );
    ...
    test("open F logo in new tab", async () => {
      ...
      const openInNewTab =
        os.getPlatform() === "mac os x"
          ? Key.chord(Key.COMMAND, Key.RETURN)
          : Key.chord(Key.CONTROL, Key.RETURN);
