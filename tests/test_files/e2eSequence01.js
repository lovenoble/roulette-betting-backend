...
const retryHelper = async (time, action, ceiling) => {
  ...
  if (retryCnt >= ceiling)
    throw new Error(`Attempted ${ceiling} retries, all failed.`);
};
...
const e2eSequence01 = () => {
  ...
  const GC_PATH = "C:\\Program Files\\Google\\Chrome\\Application\\chrome.exe"; // this path is relative to the jest runner file
  let driver;
  ...
  const PP_INPUT_01 =
    "//html/body/div[1]/div/div[2]/div/div/div[2]/form/div[1]/div[3]/div[1]/div[1]/div/input";
  const PP_INPUT_02 =
  ...
  const PASSWORD_02 =
    "//html/body/div[1]/div/div[2]/div/div/div[2]/form/div[2]/div[2]/div/input";
  const CHECKBOX =
    "//html/body/div[1]/div/div[2]/div/div/div[2]/form/div[3]/input";
  ...
  const NETWORK_TAB =
    "//html/body/div[1]/div/div[3]/div/div[2]/div[1]/div/button[6]/div[1]/div[1]";
  const LOCAL_HOST =
    "//html/body/div[1]/div/div[3]/div/div[2]/div[2]/div/div[2]/div[1]/div[6]/div[2]";
  const NETWORK_NAME_IN =
    "//html/body/div[1]/div/div[3]/div/div[2]/div[2]/div/div[2]/div[2]/div[1]/div[1]/label/input";
  const CHAIN_ID_IN =
    "//html/body/div[1]/div/div[3]/div/div[2]/div[2]/div/div[2]/div[2]/div[1]/div[3]/label/input";
  const SAVE_BTN =
    "//html/body/div[1]/div/div[3]/div/div[2]/div[2]/div/div[2]/div[2]/div[2]/button[3]";
  const IMPORT_ACCOUNT_BTN = "//html/body/div[1]/div/div[3]/div[7]";
  const PRIVATE_KEY_IN =
    "//html/body/div[1]/div/div[3]/div/div/div[2]/div[2]/div[1]/input";
  const IMPORT_BTN02 =
    "//html/body/div[1]/div/div[3]/div/div/div[2]/div[2]/div[2]/button[2]";
  ...
  const CONFIRM_BTN02 =
    "//html/body/div[1]/div/div[2]/div/div[5]/div[2]/ul/li[1]/button";
  const CONFIRM_BTN03 =
    "//html/body/div[1]/div/div[2]/div/div[5]/div[3]/footer/button[2]";
  ...
  describe("canary test", () => {
    test("check if METAMASK_PASSPHRASE01...12 is setup in /tests/.env", () => {
      const isPassphraseSetup =
        process.env.METAMASK_PASSPHRASE01.length > 0 &&
  ...
  describe("set up metamask extension and connect with DAPP", () => {
    beforeAll(async () => {
      ...
      await driver.wait(
        until.elementLocated(By.xpath(GET_STARTED_BTN)),
        20000,
        "20 second timeout",
        1000
      );
      ...
      await driver.wait(
        until.elementLocated(By.xpath(PP_INPUT_01)),
        20000,
        "20 second timeout",
        1000
      );
      ...
      await driver.wait(
        until.elementLocated(By.xpath(ALL_DONE_BTN)),
        20000,
        "20 second timeout",
        1000
      );
      ...
      await driver.wait(
        until.elementLocated(By.xpath(POP_UP_CLOSE)),
        20000,
        "20 second timeout",
        1000
      );
      ...
      await driver.wait(
        until.elementLocated(By.xpath(ACCOUNT_BTN)),
        20000,
        "20 second timeout",
        1000
      );
      ...
      await driver.wait(
        until.elementLocated(By.xpath(SETTINGS_BTN)),
        20000,
        "20 second timeout",
        1000
      );
      ...
      await driver.wait(
        until.elementLocated(By.xpath(NETWORK_TAB)),
        20000,
        "20 second timeout",
        1000
      );
      ...
      await driver.wait(
        until.elementLocated(By.xpath(LOCAL_HOST)),
        20000,
        "20 second timeout",
        1000
      );
      ...
      const network = await driver.wait(
        until.elementLocated(By.xpath(NETWORK_NAME_IN)),
        20000,
        "20 second timeout",
        1000
      );
      ...
      const chainId = await driver.wait(
        until.elementLocated(By.xpath(CHAIN_ID_IN)),
        20000,
        "20 second timeout",
        1000
      );
      ...
      await driver.wait(
        until.elementLocated(By.xpath(SAVE_BTN)),
        20000,
        "20 second timeout",
        1000
      );
      ...
      await driver.wait(
        until.elementLocated(By.xpath(IMPORT_ACCOUNT_BTN)),
        20000,
        "20 second timeout",
        1000
      );
      ...
      const privateKey = await driver.wait(
        until.elementLocated(By.xpath(PRIVATE_KEY_IN)),
        20000,
        "20 second timeout",
        1000
      );
      ...
      await privateKey
        .clear()
        .then(async () => await privateKey.sendKeys(process.env.PRIVATE));

      await driver.wait(
        until.elementLocated(By.xpath(IMPORT_BTN02)),
        20000,
        "20 second timeout",
        1000
      );
      ...
      await driver.wait(
        until.elementsLocated(By.name(GAME_MENU)),
        5000,
        "5 second timeout",
        1000
      );
    ...
    test("check target strategy: GAME_BTNS[0]", async () => {
      const wheel = await driver.wait(
        until.elementsLocated(By.name(GAME_BTNS)),
        5000,
        "5 second timeout --> check target strategy: GAME_BTNS[0]",
        1000
      );
      if (wheel[0]) {
        return true;
    ...
    test("check target strategy: GAME_MENU_MDL_BTNS[1]", async () => {
      const wallet = await driver.wait(
        until.elementsLocated(By.name(GAME_BTNS)),
        5000,
        "5 second timeout --> check target strategy: GAME_MENU_MDL_BTNS[1]",
        1000
      );
      if (wallet[1]) {
        return true;
    ...
    test("click on metamask next, connect, and sign buttons", async () => {
      await driver.wait(
        until.elementLocated(By.xpath(NEXT_BTN)),
        20000,
        "20 second timeout",
        1000
      );
      ...
      await driver.wait(
        until.elementLocated(By.xpath(SIGN_BTN)),
        20000,
        "20 second timeout",
        1000
      );
  ...
  describe("select game mode and deposit money", () => {
    test("check target strategy: GAME_MODE_BTNS[0]", async () => {
      const gameMode = await driver.wait(
        until.elementsLocated(By.name(GAME_MODE_BTNS)),
        20000,
        "20 second timeout",
        1000
      );
    ...
    */
    ...
    test("check target strategy: DEPOSIT_BTN", async () => {
      const deposit = await driver.wait(
        until.elementLocated(By.name(DEPOSIT_BTN)),
        20000,
        "20 second timeout",
        1000
      );
    ...
    test("check target strategy: DEPOSIT_MDL_IN", async () => {
      const depositInput = await driver.wait(
        until.elementLocated(By.name(DEPOSIT_MDL_IN)),
        20000,
        "20 second timeout",
        1000
      );
    ...
    test("check target strategy: DEPOSIT_MDL_DEPOSIT_BTN", async () => {
      const deposit = await driver.wait(
        until.elementLocated(By.name(DEPOSIT_MDL_DEPOSIT_BTN)),
        20000,
        "20 second timeout",
        1000
      );
    ...
    */
    ...
    test("click on 2nd deposit button", async () => {
      const deposit = await driver.findElement(
        By.name(DEPOSIT_MDL_DEPOSIT_BTN)
      );
      try {
        await deposit.click();
      } catch (e) {
    ...
    test("click on 1st metamask confirm", async () => {
      await driver.wait(
        until.elementLocated(By.xpath(CONFIRM_BTN01)),
        20000,
        "20 second timeout",
        1000
      );
    ...
    test("click on 2nd metamask confirm", async () => {
      await driver.wait(
        until.elementLocated(By.xpath(CONFIRM_BTN02)),
        20000,
        "20 second timeout",
        1000
      );
    ...
    test("check target strategy: DEPOSIT_MDL_CLOSE_BTN", async () => {
      const close = await driver.wait(
        until.elementLocated(By.name(DEPOSIT_MDL_CLOSE_BTN)),
        20000,
        "20 second timeout",
        1000
      );
  ...
  describe("select blue wheel color and enter wager amount", () => {
    test("check test strategy: COLOR_SELECTION", async () => {
      const colorSelect = await driver.wait(
        until.elementsLocated(By.name(COLOR_SELECTION)),
        20000,
        "20 second timeout",
        1000
      );
    ...
    test("check test strategy: WAGER_INPUT", async () => {
      const wager = await driver.wait(
        until.elementLocated(By.name(WAGER_INPUT)),
        20000,
        "20 second timeout",
        1000
      );
    ...
    test("check target strategy: WAGER_SUBMIT", async () => {
      const wagerSubmit = await driver.wait(
        until.elementLocated(By.name(WAGER_SUBMIT)),
        20000,
        "20 second timeout",
        1000
      );
    ...
    */
    ...
    test("click on metamask confirm", async () => {
      await driver.wait(
        until.elementLocated(By.xpath(CONFIRM_BTN03)),
        20000,
        "20 second timeout",
        1000
      );
  ...
  describe("withdraw deposited money", () => {
    test("check target strategy: WITHDRAW_BTN", async () => {
      const withdraw = await driver.wait(
        until.elementLocated(By.name(WITHDRAW_BTN)),
        20000,
        "20 second timeout",
        1000
      );
    ...
    test("check target strategy: WITHDRAW_MDL_IN", async () => {
      const withdrawInput = await driver.wait(
        until.elementLocated(By.name(WITHDRAW_MDL_IN)),
        20000,
        "20 second timeout",
        1000
      );
    ...
    test("check target strategy: WITHDRAW_MDL_WITHDRAW_BTN", async () => {
      const withdraw = await driver.wait(
        until.elementLocated(By.name(WITHDRAW_MDL_WITHDRAW_BTN)),
        20000,
        "20 second timeout",
        1000
      );
    ...
    test("click on 2nd withdraw button", async () => {
      const withdraw = await driver.findElement(
        By.name(WITHDRAW_MDL_WITHDRAW_BTN)
      );
      try {
        await withdraw.click();
      } catch (e) {
    ...
    test("check target strategy: WITHDRAW_MDL_CLOSE_BTN", async () => {
      const close = await driver.wait(
        until.elementLocated(By.name(WITHDRAW_MDL_CLOSE_BTN)),
        20000,
        "20 second timeout",
        1000
      );
