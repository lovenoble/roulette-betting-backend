...
export const CreateSeedAccountsRequest = {
  encode(message: CreateSeedAccountsRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.token !== '') {
...
export const CreateBatchEntryResponse = {
  encode(message: CreateBatchEntryResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.status !== '') {
      writer.uint32(10).string(message.status)
    }
    return writer
...
export const SettleBatchEntryResponse = {
  encode(message: SettleBatchEntryResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.status !== '') {
      writer.uint32(10).string(message.status)
    }
    return writer
...
export const PauseRoundResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<PauseRoundResponse>, I>>(object: I): PauseRoundResponse {
    const message = createBasePauseRoundResponse()
    message.status = object.status ?? ''
    return message
  },
