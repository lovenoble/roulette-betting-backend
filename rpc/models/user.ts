...
export const SetUserDataRequest = {
  ...
  fromJSON(object: any): SetUserDataRequest {
    return {
      ...
      colorTheme: isSet(object.colorTheme) ? userColorThemeFromJSON(object.colorTheme) : undefined,
    }
  },
  ...
  toJSON(message: SetUserDataRequest): unknown {
    ...
    message.colorTheme !== undefined &&
      (obj.colorTheme =
        message.colorTheme !== undefined ? userColorThemeToJSON(message.colorTheme) : undefined)
    return obj
  },
